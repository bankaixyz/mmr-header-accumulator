use rust_vm_hints::vm::cairo_vm::{
    hint_processor::builtin_hint_processor::{builtin_hint_processor_definition::HintProcessorData, hint_utils::{get_integer_from_var_name, insert_value_from_var_name}},
...
pub fn mmr_left_child(
    ...
    let in_mmr = if left_child <= mmr_len { Felt252::ONE } else { Felt252::ZERO };
...
pub fn hint_is_position_in_mmr_array(
    ...
    let is_position_in_mmr_array = if position > mmr_offset { Felt252::ONE } else { Felt252::ZERO };
    insert_value_from_var_name(
