...
func keccak_uint256{
    range_check_ptr, keccak_ptr: KeccakBuiltin*, bitwise_ptr: BitwiseBuiltin*
}(leaf: Uint256) -> (res: Uint256) {
...
func poseidon_uint256{
    range_check_ptr, poseidon_ptr: PoseidonBuiltin*
}(leaf: Uint256) -> (res: felt) {
